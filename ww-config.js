                  ...
                  item: {
                    ...
                    options: (content, sidePanelContent, boundProperties, wwProps, colArray) => ({
                      ...
                      propertiesOrder: [
                        ...
                        { label: "", properties: ["optionsValueKey"] },
                        { label: "", properties: ["optionsLabelKey"] },
                        { label: "", properties: ["optionsThreshold"] },
                        { label: "", properties: ["multiple"] },
                        { label: "", properties: ["searchDebounce"] },
                        { label: "", properties: ["searchValueKey"] },
                        { label: "", properties: ["searchLabelTemplate"] },
                        { label: "", properties: ["phoneDefaultCountry"] },
                        { label: "", properties: ["phoneStoreFormat"] },
                        { label: "", properties: ["required"] },
                        { label: "", properties: ["isPrimaryColumn"] },
